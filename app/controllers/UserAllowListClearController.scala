...
@Singleton
class UserAllowListClearController @Inject()(
                                             override val controllerComponents: MessagesControllerComponents,
                                             auth: FrontendAuthComponents,
                                             view: UserAllowListClearView,
                                             formProvider: FeatureFormProvider,
  ...
  private def authorised(service: String) =
    auth.authorizedAction(
      continueUrl = routes.UserAllowListClearController.onPageLoad(service),
